    ...
    <div class="container" id="main">
        <div id="footer" class="container">
            <header class="major">
                ...
                <p><i>Via ce formulaire, vous pourrez vous inscrire pour crée votre compte client sur notre boutique.</i></p>
            </header>
            <div class="row.aln-center">
                <section class="col-6 col-12-narrower">
                    <form name="form" method="post" action="index.php?controleur=Admin&action=validerInscription">
                        <div class="row gtr-50">
                            <div class="col-6 col-12-mobile">
                                <input name="name" placeholder="Nom" type="text" required="required" />
                            </div>

                            <div class="col-6 col-12-mobile">
                                <input name="lastname" placeholder="Prénom" type="text" required="required" />
                            </div>
                            ...
                            <div class="col-6 col-12-mobile">
                                <input name="password" placeholder="Mot De Passe" type="password" required="required" />
                            </div>

                            <div class="col-6 col-12-mobile">
                                <input name="adresse" placeholder="Adresse, lieu de résidence" type="text" required="required" />
                            </div>

                            <div class="col-6 col-12-mobile">
                                <input name="phoneNumber" placeholder="Numéro de téléphone" type="text" required="required" />
                            </div>
                            ...
                            <div class="col-12">
                                <ul class="actions">
                                    <li><input type="submit" name="Valider" value="S'inscrire" /></li>
...
<?php
//$lesClients = GestionBoutiquePPE::getLesClients();
//var_dump($lesClients);
//
//$leClient = GestionBoutiquePPE::getClientById(2);
//var_dump($leClient);
//
//$nbClients = GestionBoutiquePPE::getNbClient();
//echo "Nous avons actuellement $nbClients membre(s) inscrits sur notre boutique !";
//
//GestionBoutiquePPE::addClient('NomTest', 'PrenomTest', 'test.test@gmail.com', 'LoginTest', 'MdpTest', 'AdresseTest', '0101010101', 'paysTest');
//var_dump(GestionBoutiquePPE::getLesClients());
//
//GestionBoutiquePPE::supprimerMembre(1);
//var_dump(GestionBoutiquePPE::getLesClients());
//
//GestionBoutiquePPE::setmdpClient(1, "NOUVEAU PASSE DE TEST");
//var_dump(GestionBoutiquePPE::getLesClients());
?>
