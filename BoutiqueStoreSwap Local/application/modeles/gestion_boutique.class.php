...
//<editor-fold defaultstate="collapsed" desc="Méthodes statiques">
    ...
    public static function getAvisClientById($id) {
        self::seConnecter();
        self::$requete = "SELECT * FROM avisclient";
        self::$pdoStResults = self::$pdoCnxBase->prepare(self::$requete);
        self::$pdoStResults->execute();
        self::$resultat = self::$pdoStResults->fetch();
        self::$pdoStResults->closeCursor();
    ...
    public static function supprimerAvisClient($id) {
        self::seConnecter();
        self::$requete = "DELETE FROM avisclient WHERE id = $id";
        self::$pdoStResults = self::$pdoCnxBase->prepare(self::$requete);
        self::$pdoStResults->execute();
        
    }

    public static function supprimerCategorie($idCategorie) {
        self::seConnecter();
        self::$requete = "DELETE FROM categorie WHERE idCategorie = $idCategorie";
        self::$pdoStResults = self::$pdoCnxBase->prepare(self::$requete);
        self::$pdoStResults->execute();
    ...
    public static function supprimerCommande($idCommande) {
        self::seConnecter();
        self::$requete = "DELETE FROM commande WHERE idCommande = $idCommande";
        self::$pdoStResults = self::$pdoCnxBase->prepare(self::$requete);
        self::$pdoStResults->execute();
    ...
    public static function supprimerFournisseur($idFournisseur) {
        self::seConnecter();
        self::$requete = "DELETE FROM fournisseur WHERE idFournisseur = $idFournisseur";
        self::$pdoStResults = self::$pdoCnxBase->prepare(self::$requete);
        self::$pdoStResults->execute();
    ...
    public static function getLesClientsAll() {
        self::seConnecter();
